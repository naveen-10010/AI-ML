      ...
      for (x, y, w, h) in faces:
          ...
          if len(captured_face_encodings) > 0:
              ...
              if any(results):
                  ...
                  def button1():
                    ...
                    while True:
                        ...
                        for i, (x, y, w, h) in enumerate(faces):
                            ...
                            name = input(f"Enter the rollno of student {i+1} in the face: ")
                  ...
                  button1 =tk.Button(new_window, text="add staff", width=20, height=2, command=button1, bg="red")
...
button1 = tk.Button(window, text="open door", width=20, height=2, command=execute_function, bg="red")
button1.pack(pady=10)

button2 = tk.Button(window, text="administrator control", width=20, height=2, command=execute_condition, bg="red")
button2.pack(pady=10)
